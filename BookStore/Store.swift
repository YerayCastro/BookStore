...
class Store: NSObject, ObservableObject {
    ...
    "com.yerycastro.BookStore.codigoDaVinci",
    "com.yerycastro.BookStore.harryPotter",
    "com.yerycastro.BookStore.fullAccess"
    ])
    ...
    func productsRequest(_ request: SKProductsRequest, didReceive response: SKProductsResponse) {
        ...
        guard !loadedProducts.isEmpty else {
            ...
            if !invalidProducts.isEmpty  {
                print("productos invalidos encontrados: \(invalidProducts)")
            }
            productsRequest = nil
            return
        }
